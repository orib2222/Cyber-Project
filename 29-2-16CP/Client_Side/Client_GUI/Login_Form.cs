...
namespace Client_GUI
{
    public partial class Login_Form : Form
    {
        ...
        public void Client_Activation()
        {
            ...
            pythonProcess.StartInfo.Arguments = @"C:\Users\User\Desktop\29-2-16CP\Client_Side\Client_GUI\bin\Debug\Python\Client.py";
        ...
        public void KBF_Activation()
        {
            Process pythonProcess = new Process();
            pythonProcess.StartInfo.FileName = @"C:\Python27\python.exe";
            pythonProcess.StartInfo.Arguments = @"C:\Users\User\Desktop\29-2-16CP\Client_Side\Client_GUI\bin\Debug\Python\Freeze_KeyBoard.py";
            pythonProcess.StartInfo.WorkingDirectory = Application.StartupPath;
            pythonProcess.StartInfo.WindowStyle = ProcessWindowStyle.Hidden;
            pythonProcess.Start();
