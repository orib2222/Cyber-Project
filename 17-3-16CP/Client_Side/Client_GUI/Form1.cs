...
namespace Client_GUI
{
    public partial class Form1 : Form
    {
        ...
        //public void Killing_Client_Process()
        //{
        //    Process p = Process.GetProcessById(Client_Procees_ID);
        //    p.Kill();
        //}

        private void OnShowStatus(object sender, EventArgs e)
        {
            MessageBox.Show("You Are Protected");
        }
