...
namespace Client_GUI
{
    public partial class Login_Form : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e) // Clients Pressed Submit
        {
        ...
        private void button2_Click(object sender, EventArgs e) // Manager Temporary Button
        {       
            this.Invoke((MethodInvoker)delegate
            {
                GetProcessesByName kill = new GetProcessesByName(this.Killing_Python_Procsess);
        ...
        public void Killing_Python_Procsess() // Kills All Python Process
        {           
            try
            {
        ...
        private void myFunction(object sender, myEventArgs e)  // Gets The Client Information After Registered
        {
